            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link nav-me" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Home</a>
                        <a class="nav-link nav-me" id="v-pills-summer-tab" data-toggle="pill" href="#v-pills-summer" role="tab" aria-controls="v-pills-summer" aria-selected="false">Summer Internship Forms</a>
                        <a class="nav-link nav-me" id="v-pills-longterm-tab" data-toggle="pill" href="#v-pills-longterm" role="tab" aria-controls="v-pills-longterm" aria-selected="false">Long Term Internship Forms</a>
                    </div>
                </div>
                ...
                <div class="col-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <li><i class="fa fa-hand-o-right"></i> Step-1 : Download Forms from this section as per your requirement.Take a xerox.Fill Carefully</li>
                            <li><i class="fa fa-hand-o-right"></i> Step-2 : Now go for signatures (Your Project Guide , DPN , HOD) then contact CDPC Cell for verification</li>
                            <!-- <li><i class="fa fa-hand-o-right"></i> Step-3 : If You are male then go to Dean Academics Office directly. If not go for DSW Office then go for Dean Academics Offices </li> -->
                        </div>
                        
                        <!-- Placements Body Starts-->
                        <div class="tab-pane fade" id="v-pills-summer" role="tabpanel" aria-labelledby="v-pills-summer-tab">
                            <div class="alert alert-info">
                                <i class="fa fa-hand-o-right"></i> <b>Forms to be submitted before leaving the campus to Summer Internship</b>
                            </div>
                            
                            <!--Table froms to be submitted before leaving campus-->
                            ...
                            <div class="alert alert-info">
                                <i class="fa fa-hand-o-right"></i> <b>Forms to be submitted before coming to the campus from Summer
                                    Internship for completing examination work</b>
                            </div>
                            
                            
                            <!--Table froms to be submitted before Coming to campus-->
                            <table class="table table-bordered table-stripped">
                                <thead>
                                    <tr>
                                        <th>Filename</th>
                        ...
                        <!-- Summer Body Starts-->
                        <div class="tab-pane fade" id="v-pills-longterm" role="tabpanel" aria-labelledby="v-pills-longterm-tab">
                            <div class="alert alert-info">
                                <i class="fa fa-hand-o-right"></i> <b>Forms to be submitted before leaving the campus to Long Term Internship</b>
                            </div>
                            <table class="table table-bordered table-stripped">
                                <thead>
                                    <tr>
                            ...
                            <div class="alert alert-info">
                                <i class="fa fa-hand-o-right"></i> <b> Forms to be submitted before coming to the campus from Long Term Internship for completing examination work</b>
                            </div>
                            <table class="table table-bordered table-stripped">
                                <thead>
                                    <tr>
